...
public class Prueba_PhoneReceiver_con_AudioManagerActivity extends Activity {
	...
	private final static String NO_NUMBER = "No tiene n�mero";
    ...
    public void save(View v){
    	...
    	Toast.makeText(this.getApplicationContext(), "N�mero silenciado: "+number,
    		Toast.LENGTH_SHORT).show();
    	
    	//Registrar el BroadcastReceiver( si est� registrado en el Manifest, se dispara a�n que est� cerrado la aplicaci�n)
    ...
    public void remove(View v){
    	...
    	String number = this.sp.getString(DB_NAME, "No existe el n�mero");
    	...
    	Toast.makeText(this.getApplicationContext(), "N�mero borrado: "+number,
    		Toast.LENGTH_SHORT);
    	
    	//Si el broadcastreceiver no existe, lanza una excepci�n
...
//    	super.onActivityResult(requestCode, resultCode, data);
    	...
    	//Si el usuairo no ha seleccionado ning�n usuario, el resultCode ser� 0
    ...
    public String searchContactNumber(Intent intent){
    	...
    	//Verificar si el contacto tiene n�mero de tel�fono
		...
		//Puede ser que el contacto tenga varios teléfonos. Devuelve el último número registrado
